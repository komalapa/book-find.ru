...
export default {
  ...
  methods: {
    ...
    exitByClick: function(e){
      ...
      if (
        (e.path[0] === document.querySelector("#app > div > div.login-wrp"))//document.querySelector("#app > div.login-wrp > div")) 
        )
        {
        this.isLoginFormVisible = false
      }
      if (
        (e.path[0] === document.querySelector("#app > div > div.reg-wrp"))//document.querySelector("#app > div.reg-wrp > div")) 
        )
        {
        this.isRegFormVisible = false
      }
